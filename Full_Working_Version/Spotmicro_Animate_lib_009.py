...
class SpotAnim:
    ...
    def animate(self, pos, t, thetax, thetaz, angle, center_x, center_y, thetalf, thetarf, thetarr, thetalr, walking_speed, walking_direction, steering, stance):
        ...
        ZMPabs = Spot.new_coordinates(
            M, ZMP[0], ZMP[1], 0, x_spot[1], y_spot[1], z_spot[1])
        ...
        lineZMP = SpotAnim.display_rotate(self, -x_spot[0], -y_spot[0], -z_spot[0], [
                                          0, 0, 0, 0, 0, 0], thetax, thetaz, [ZMPabs[0], CGabs[0]], [ZMPabs[1], CGabs[1]], [0, 0])
        if sum(stance) > 2:
